# -*- coding: utf-8 -*-
"""Allegro_X_Music_Transformer_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TWWM9q3aVq_bf88NrDaYuFJMyT3kTfSU

# Allegro X Music Transformer Maker (ver. 1.0)
...
x = torch.tensor([[1091, 960+0, 962+0]] * 4, dtype=torch.long, device=device_type)
...
detailed_stats = TMIDIX.Tegridy_ms_SONG_to_MIDI_Converter(song_f,
                                                    ...
                                                    output_file_name = '/content/Allegro-X-Music-Transformer-Composition',
...
plt.tight_layout()
plt.plot()
plt.savefig("/content/Allegro-X-Music-Transformer-Tokens-Embeddings-Plot.png", bbox_inches="tight")
