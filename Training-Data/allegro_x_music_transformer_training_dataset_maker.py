...
Original file is located at
    https://colab.research.google.com/drive/1ULRnood0OeFCJ9ARrtP1X6is391HLNqg

# Allegro X Music Transformer Training Dataset Maker (ver. 1.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
              ...
              if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                ...
                if 9 in instruments_list:
                  drums_present = 17795 # Yes
                else:
                  drums_present = 17794 # No
                ...
                melody_chords2.extend([17925, drums_present, 17796+pat]) # Intro seq

                #=======================================================

                # TOTAL DICTIONARY SIZE 17925+1=17926
                ...
                for m in melody_chords:
                    ...
                    if (comp_chords_len - chords_counter) == 50:
                        melody_chords2.extend([17793]) # Outro token seq

                    if chords_counter % 50 == 0:
                        nct = 17281+min(511, ((chords_counter // 50)-1)) # chords counter token
                    ...
                    pat_ptc = (129 * pat) + m[3] # 16641 tokens range total for patches+pitches
                    ...
                    if m[0] != 0:
                        ...
                        if m[4] != pvs[pat]:
                            melody_chords2.extend([m[4]+17153]) # Velocity tokens

                        melody_chords2.extend([m[1]+256, pat_ptc+512]) # Main tokens pair (Dur and Patch+Pitch)
                ...
                melody_chords2.extend([17925]) # EOS
