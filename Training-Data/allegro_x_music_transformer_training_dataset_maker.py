...
# Allegro X Music Transformer Training Dataset Maker (ver. 3.0)
            ...
            if min([e[1] for e in events_matrix1]) >= 0 and min([e[2] for e in events_matrix1]) >= 0:
              ...
              if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
                ...
                for m in melody_chords:
                    ...
                    if (comp_chords_len - chords_counter) == 50 and outro_once:
                        melody_chords2.extend([959]) # Outro token seq
                        outro_once = False

                    if chords_counter % 50 == 0 and chords_counter_once:
                        nct = 704+min(255, ((chords_counter // 50)-1)) # chords counter token
                        melody_chords2.extend([nct])
                        chords_counter_once = False
